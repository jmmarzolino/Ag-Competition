...
# set up phenotypes in fam file for genotypes in common between field and greenhouse experiments
...
write_delim(join, "exp_common.fam", delim=" ", col_names=F)
