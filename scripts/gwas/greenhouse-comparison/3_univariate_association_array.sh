...
PHENO_NAME="ASSOC_exp_common_${COL}_lmm"
PHENO_NAME_GHONLY="ASSOC_GH_only_${COL}_lmm"
...
# univariate linear MIXED model
/rhome/jmarz001/software/gemma0.98.5 -bfile exp_common -k output/related_matrix.cXX.txt -c exp_common_pca.txt -lmm 4 -n $SLURM_ARRAY_TASK_ID -outdir . -o "$PHENO_NAME" -debug

## gwas w only greenhouse results
/rhome/jmarz001/software/gemma0.98.5 -bfile gh_only -k output/related_matrix_gh_only.cXX.txt -c gh_only_pca.txt -lmm 4 -n $SLURM_ARRAY_TASK_ID -outdir . -o "$PHENO_NAME_GHONLY" -debug
