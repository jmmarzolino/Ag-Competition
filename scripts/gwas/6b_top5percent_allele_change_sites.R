...
#SBATCH --job-name=deltaAF
#SBATCH -o /rhome/jmarz001/bigdata/Ag-Competition/scripts/gwas/6b_top5percent_allele_change_sites.stdout
#SBATCH --ntasks=1
#SBATCH --mem=80gb
#SBATCH -t 10:00:00
#SBATCH -p koeniglab
...
# read in list of top 5% sites
fread("ASSOC_6_top_sites.txt")
