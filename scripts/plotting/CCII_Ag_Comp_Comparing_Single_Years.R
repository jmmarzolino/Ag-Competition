...
correct <- c("Genotypes", "Condition", "Generation", "Brown Bag Weight", "100 seed weight", "Fecundity", "Fitness", "FT_DAYS", "Haplotype", "Atlas_Avg_Fec", "Atlas_Avg_Fitness", "Atlas_Avg_Total_Weight", "Centered_Fit", "Centered_FT", "Centered_Fec", "Centered_TW", "Exp_Fec_Per_Plant",
...
### TW
ggplot(Combined_Single_Years, aes(total_seed_mass_g_2021_2022, `Brown Bag Weight`), add = "reg.line") +
  geom_point() +
...
### Flowering
ggplot(Combined_Single_Years, aes(Flowering_Date_2021_2022, FT_DAYS), add = "reg.line") +
  geom_point() +
...
ggplot(Combined_Single_Years_Distribution, aes(x = FT_DAYS, fill = Year)) +
  geom_density(alpha = .5) +
