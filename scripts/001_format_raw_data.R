...
### Join years of data
sw_join <- full_join(sw3, sw7, by = c("Genotype", "Germination"="Plants", "Condition", "Replicate", "FT", "TOTAL_MASS", "SEED_WEIGHT_100", "Exp_year", "BED_2021" = "BED_2022", "ROW_2021" = "ROW_2022")) 
